...
Statistical analyses \cite{starnes:2015:practice} were performed in R \cite{R} using the \texttt{ggplot2} and \texttt{dplyr} libraries \cite{ggplot2, dplyr}
...
\end{center}
\caption{Position, velocity, and acceleration versus time for a representative tennis ball and a representative cricket ball}
\label{fig:41}
\end{figure}
%\begin{figure}  
